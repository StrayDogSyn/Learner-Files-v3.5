...
export class ContextManager {
    constructor() {
        ...
        Object.defineProperty(this, "userSessions", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        }); // userId -> sessionIds
        Object.defineProperty(this, "domainContexts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "maxSessionsPerUser", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 10
        });
        Object.defineProperty(this, "maxConversationLength", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 50
        });
        Object.defineProperty(this, "sessionTimeout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 3600000
     ...
     */
    async createSession(userId, domain, userRole, initialContext) {
     ...
     */
    async updateContext(sessionId, entry, tokensUsed) {
        const session = this.sessions.get(sessionId);
        if (!session || !session.isActive) {
     ...
     */
    async switchDomain(sessionId, newDomain, preserveHistory = true) {
        const session = this.sessions.get(sessionId);
        if (!session || !session.isActive) {
            throw new Error(`Session not found or inactive: ${sessionId}`);
        }
     ...
     */
    updateDomainContext(domain, updates) {
