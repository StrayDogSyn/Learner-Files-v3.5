...
export class JusticeAIService {
  private domain: DomainType = 'justice';
...
Format: Detailed policy analysis with evidence-based recommendations and implementation roadmap.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'policy_analysis' as ContentType,
      userId,
      userRole,
      tier
    );
...
Format: Detailed legal research memo with citations, analysis, and practical guidance.`;
   ...
   */
  async generateReformProposal(
    request: ReformProposalRequest,
    userId: string,
    userRole: UserRole,
    tier: RateLimitTier
  ): Promise<ServiceResponse<string>> {
...
Format: Professional reform proposal with evidence-based recommendations and implementation framework.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'reform_proposal' as ContentType,
      userId,
      userRole,
      tier
    );
...
Format: Detailed compliance assessment with actionable recommendations and implementation plan.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'compliance_assessment' as ContentType,
      userId,
      userRole,
      tier
    );
   ...
   */
  async generateSocialImpactReport(
    program: string,
    metrics: Array<{
      name: string;
      baseline: number;
...
Format: Professional impact report with data visualization descriptions, case studies, and strategic insights.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'social_impact_report' as ContentType,
      userId,
      userRole,
      tier
    );
   ...
   */
  async analyzeCriminalJusticeTrends(
    jurisdiction: string,
    timeframe: string,
    focusAreas: string[],
    dataPoints: Array<{
...
Format: Analytical report with data insights, trend analysis, and evidence-based recommendations.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'criminal_justice_trends' as ContentType,
      userId,
      userRole,
      tier
    );
   ...
   */
  async generateAdvocacyStrategy(
    cause: string,
    objectives: string[],
...
Format: Strategic advocacy plan with tactical recommendations and implementation framework.`;
    ...
    return await aiService.generateContent(
      prompt,
      this.domain,
      'advocacy_strategy' as ContentType,
      userId,
      userRole,
      tier
    );
