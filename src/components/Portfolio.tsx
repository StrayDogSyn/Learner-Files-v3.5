            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <GlassCard variant="hunter" className="h-full">
                ...
                <p className="text-hunter-sage mb-6 leading-relaxed">
                  After 20+ years leading fine dining kitchens, I discovered that the same principles that create 
                  exceptional culinary experiences translate beautifully to software development. The attention to 
                  detail, systematic thinking, and relentless pursuit of perfection that defined my culinary career 
                  now drive my approach to creating digital solutions.
                </p>
                <p className="text-hunter-sage mb-6 leading-relaxed">
                  My transition from chef to developer wasn't just a career change—it was an evolution. The 
                  problem-solving skills honed in high-pressure kitchen environments, combined with a natural 
                  curiosity for technology, led me to discover my passion for JavaScript, AI/ML, and creating 
                  user experiences that feel as refined as a perfectly plated dish.
                </p>
                <p className="text-hunter-sage leading-relaxed">
                  Today, I bring that same hospitality mindset to every project, ensuring that both the code 
                  and the client experience meet the highest standards. Whether it's building responsive web 
                  applications, integrating AI solutions, or solving complex technical challenges, I approach 
                  each project with the precision and care that comes from years of professional excellence.
                </p>
              </GlassCard>
          ...
          <div className={`transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <GlassCard variant="hunter" className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-hunter-emerald to-metallic-silver rounded-full flex items-center justify-center mx-auto mb-6">
                  <FaRocket className="text-2xl text-charcoal-dark" />
                </div>
                <h3 className="font-display text-xl font-semibold mb-4 text-glass-light">
                  AI Integration
                </h3>
                <p className="text-hunter-sage">
                  Leveraging Claude API, OpenAI, and custom ML models to create intelligent, responsive applications
                </p>
              </GlassCard>
              
              <GlassCard variant="premium" className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-metallic-silver to-hunter-core rounded-full flex items-center justify-center mx-auto mb-6">
                  <FaLightbulb className="text-2xl text-charcoal-dark" />
                </div>
                <h3 className="font-display text-xl font-semibold mb-4 text-glass-light">
                  Innovation Mindset
                </h3>
                <p className="text-hunter-sage">
                  Constantly exploring emerging technologies and finding creative solutions to complex problems
                </p>
              </GlassCard>
              
              <GlassCard variant="hunter" className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-hunter-core to-hunter-forest rounded-full flex items-center justify-center mx-auto mb-6">
                  <FaDatabase className="text-2xl text-charcoal-dark" />
                </div>
                <h3 className="font-display text-xl font-semibold mb-4 text-glass-light">
